...
\begin{corollary}
  ...
  \item $\PCPcs{\NC^k}{1}{\frac{1}{2}}{\lg \lg n}{O(1)} = \NNC^k(\lg n) = \NC^k$,
  \item $\PCPcs{\NC^k}{1}{\frac{1}{2}}{0}{O(\polylog)} \subseteq \NNC^k(\polylog)$, and
  \item $\PCPcs{\NC^k}{1}{\frac{1}{2}}{O(\lg \lg n)}{O(1)} \subseteq \NNC^k(\polylog)$.
  \end{enumerate}
\end{corollary}
...
\begin{corollary}
  ...
  \item $\PCPcs{\NC}{1}{\frac{1}{2}}{\lg \lg n}{O(1)} = \NNC(\lg n) = \NC$,
  \item $\PCPcs{\NC}{1}{\frac{1}{2}}{0}{O(\polylog)} \subseteq \NNC(\polylog)$, and
  \item $\PCPcs{\NC}{1}{\frac{1}{2}}{O(\lg \lg n)}{O(1)} \subseteq \NNC(\polylog)$.
  \end{enumerate}
\end{corollary}
