%% ncpcp.tex - probabilistically checkable proofs for NC verifiers
%%
...
\hypersetup{pdftitle={Restricted probabilistically checkable proofs}, pdfauthor={Jeffrey Finkelstein}}

\addbibresource{ncpcp.bib}
...
\symbolfootnote{%
  ...
  The \LaTeX{} markup that generated this document can be downloaded from its website at \mbox{\url{https://github.com/jfinkels/ncpcp}}.
...
\todo{Further evidence that $\NC \neq \NNC(\polylog)$ is that $\NNC(\polylog) = \NC \subseteq \P$ implies $\W[P]$ collapses to $\FPT$}
