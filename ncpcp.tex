...
However, it is not obvious how to adapt this result to the \NC{} setting, so it remains a possibility that $\NNC(\polylog) \subseteq \PCP^\NC[o(\log n), o(\log n)]$.
\textbf{TODO examine translating this to the NC setting...}
