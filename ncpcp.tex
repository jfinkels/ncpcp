...
We call such a graph a \emph{constraint graph}.
...
Matrix multiplication is in \NC{}, and a constant number of matrix multiplications remains in \NC{}.
...
\begin{lemma}
  Constraint graph powering with an exponent in $O(1)$ is computable by an \NC{} algorithm.
\end{lemma}
...
\begin{lemma}
  Assignment testing composition is computable by an \NC{} algorithm.
\end{lemma}
