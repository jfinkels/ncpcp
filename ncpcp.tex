...
See \cite{bcgt13, smbw12, svpbbw12, trmp12, gkr08} for more information.
...
This theorem provides that evidence.
...
%% The following theorem is a generalization of \cite[Theorem~18]{trevisan98} that uses approximability of problems for which an exact solution is infeasible to construct an efficient deterministic simulation of PCP verifiers.
