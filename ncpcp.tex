...
\begin{lemma}[{\cite[Lemma~4]{fs96}}]\label{lem:derandomize}
  \begin{equation*}
    \PCPcs{\NC^k}{1}{\frac{1}{2}}{O(\lg \lg n)}{O(1)} \subseteq \PCPcs{\NC^k}{1}{\frac{1}{2}}{\lg \lg n + O(1)}{O(1)}.
  \end{equation*}
\end{lemma}
\begin{proof}
  TODO copy proof
...
\begin{proof}
  ...
  In fact, the procedure in steps 2 and 3 is a correct algorithm for the more general constraint satisfaction problem.
...
The technique used in the proof of the preceding theorem also yields the following.
